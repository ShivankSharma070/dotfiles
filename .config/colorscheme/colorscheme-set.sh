...
generate_kitty_config() {
  kitty_conf_file="$HOME/.config/kitty/theme.conf"
...
if [ "$UPDATED" = true ]; then
  ...
  cp "$colorscheme_file" "$HOME/.config/nvim/lua/shivank/plugins/colorscheme/active-colorscheme.sh"
...
# If active-colorscheme.sh doesn't exist, create it
  ...
  generate_ghostty_config
  echo "Can't reload ghostty, manually reload it"
