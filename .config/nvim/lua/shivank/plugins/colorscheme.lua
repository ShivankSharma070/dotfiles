...
return {
	{
		...
		config = function()
			...
			local border = "#547998"
			local purple_gray = "#7a9fa1"

			require("tokyonight").setup({
				transparent = nottosetbackground,
				style = "storm", -- other options -> night, moon, strom
...

	{
		...
		config = function()
			require("catppuccin").setup({
				...
				color_overrides = {
					mocha = {
						base = "#11111b", -- darker than default
						mantle = "#0b0b12", -- optional: darker UI layers
						crust = "#050508", -- optional: very dark borders/statusline
					},
				},
				custom_highlights = {},
		...
		config = function(_, opts)
			require("nightfox").setup({
				options = {
					...
					transparent = nottosetbackground, -- Disable setting background
